...
/**
 * Data Transfer Object (DTO) que representa una solicitud para crear o actualizar un evento.
 * Este objeto se utiliza para recibir información desde el cliente hacia el backend.
 * 
...
public class EventRequest {
    ...
    /** 
     * Nombre del evento. 
     * Debe contener un máximo de 20 caracteres y no puede estar vacío.
     */
     ...
     * Debe contener un máximo de 200 caracteres y no puede estar vacía.
     */
     ...
     * Debe contener un máximo de 20 caracteres y no puede estar vacía.
     */
    ...
    /** 
     * Nombre del lugar donde se llevará a cabo el evento. 
     * Debe contener un máximo de 20 caracteres y no puede estar vacío.
     */
    ...
    /** 
     * Género o tipo de música asociado al evento.
     * Debe ser un valor válido del enumerado {@code Genre}.
     */
    @NotNull(message = "El género no puede estar vacío")
    private Genre genre;

    /**
     * Convierte el objeto {@code EventRequest} en una entidad {@code Event}.
     * Este método se utiliza para mapear los datos recibidos en un formato compatible
